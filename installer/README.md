...
& "C:\Python27\python.exe" build\build_wotmod.py        # -> dist\com.14th_ua.garageprogressbar_0.5.1.wotmod

# 2. Install Inno Setup once (provides ISCC.exe):
winget install -e --id JRSoftware.InnoSetup

# 3. Compile:
pwsh installer\build_installer.ps1                      # -> dist\GarageProgressBar-Setup-0.5.1.exe
```
