...
& "C:\Python27\python.exe" build\build_wotmod.py        # -> dist\com.drizzer14.wgmod_0.1.0.wotmod

# 2. Install Inno Setup once (provides ISCC.exe):
winget install -e --id JRSoftware.InnoSetup

# 3. Compile:
pwsh installer\build_installer.ps1                      # -> dist\ResearchProgressBar-Setup-0.1.0.exe
```
