...
2. Run **`GarageProgressBar-Setup-0.6.4.exe`**.
...
3. Copy **`com.14th_ua.garageprogressbar_0.6.4.wotmod`** into that folder.
...
`com.14th_ua.garageprogressbar_0.6.4.wotmod`.
...
`com.14th_ua.garageprogressbar_0.6.4.wotmod` from `mods\<version>\`, then restart the client.
