...
2. Run **`GarageProgressBar-Setup-0.8.0.exe`**.
...
3. Copy **`com.14th_ua.garageprogressbar_0.8.0.wotmod`** into that folder.
...
`com.14th_ua.garageprogressbar_0.8.0.wotmod`.
...
`com.14th_ua.garageprogressbar_0.8.0.wotmod` from `mods\<version>\`, then restart the client.
