...
2. Run **`GarageProgressBar-Setup-0.5.1.exe`**.
...
3. Copy **`com.14th_ua.garageprogressbar_0.5.1.wotmod`** into that folder.
...
`com.14th_ua.garageprogressbar_0.5.1.wotmod`.
...
`com.14th_ua.garageprogressbar_0.5.1.wotmod` from `mods\<version>\`, then restart the client.
