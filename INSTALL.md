...
2. Run **`GarageProgressBar-Setup-1.2.1.exe`**.
...
3. Copy **`com.14th_ua.garageprogressbar_1.2.1.wotmod`** into that folder.
...
`com.14th_ua.garageprogressbar_1.2.1.wotmod`.
...
`com.14th_ua.garageprogressbar_1.2.1.wotmod` from `mods\<version>\`, then restart the client.
