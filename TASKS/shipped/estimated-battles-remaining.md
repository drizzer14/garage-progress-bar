...
_Submitted: "Display estimated battles remaining alongside XP remaining in tooltips" · Status: shipped (commits ebf0392 "feat: estimated battles remaining beside tooltip XP shortfall" + 370e3f0 "feat: bonus-aware battles-remaining range")_

> Note: restored to shipped/ by the plan saver — the original was deleted (not
> archived) when the feature shipped. Recovered from git (ebf0392^). The
> authoritative record is the commits above; consult their diffs.
